...
/***/ (function(module, exports, __webpack_require__) {
	...
	$(document).ready(function() {
	  ...
	  Ellipsis.watch('[am-mission-tile~=title]');
	
	  // Filters
	  Filter.sort('[am-filter~=link][data-tags]', '[am-col~=item]', '[am-filter~=list]', '[am-filter~=toggle]');
	  Filter.sort('[am-filter~=sub-link]', '[am-col~=item]');
	  Filter.init('[am-filter~=dropdown] > [am-filter~=link]','[am-filter~=toggle]');
	
	  $('[am-filter~=not-completed]').click( function() {
	    $('[am-filter~=surprise-me]').removeClass('active');
	    $(this).addClass('active');
	  });
	
	  $('[am-filter~=surprise-me]').click( function() {
	    $('[am-filter~=not-completed]').removeClass('active');
	    $(this).addClass('active');
	  });
	});
...
/***/ })
/******/ ]);
//# sourceMappingURL=learning-hub.min.js.map
//# sourceMappingURL=learning-hub.min.js.map
