...
/***/ (function(module, exports, __webpack_require__) {
	...
	$(document).ready(function() {
	  ...
	  Modal.init();
	  Height.init('[am-product~=container]', '[am-rewards~=grid] > [am-col]');
	  UserMessage.init();
	  Ellipsis.watch('[am-product~=description]');
	
	  // Activate modal
	  $('[am-product~=add]').on('click', function(e) {
...
/***/ })
/******/ ]);
//# sourceMappingURL=rewards.min.js.map
//# sourceMappingURL=rewards.min.js.map
