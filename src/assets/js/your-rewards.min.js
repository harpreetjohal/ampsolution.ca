...
/***/ (function(module, exports, __webpack_require__) {
	...
	$(document).ready(function() {
	  ...
	  $('[am-digital^=btn-]').each(function ( index ) {
	    index = index + 1;
	    Clipboard.init('[am-digital~=btn-' + index + ']', '[am-digital~=code-' + index + ']');
	  });
	
	  // Filters
	  Filter.sort('[am-filter~=link]', '[am-code~=container]', '[am-filter~=list]', '[am-filter~=toggle]');
...
/***/ (function(module, exports) {
	...
	module.exports = {
	  ...
	  init: function(btn, text) {
	    ...
	    $(btn).on('click', function(e) {
	      ...
	      var textInput = $(text)[0],
	          textselect = scope.getSelectionText();
	
	      textInput.focus();
	      scope.selectElementText(textInput);
	      scope.copySelectionText(textselect, text);
	  ...
	  copySelectionText: function(e, el) {
	    var copysuccess;
...
/***/ })
/******/ ]);
//# sourceMappingURL=your-rewards.min.js.map
//# sourceMappingURL=your-rewards.min.js.map
